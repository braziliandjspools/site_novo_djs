...
export function AllavsoftPlatformsMarquee() {
  ...
  return (
    <div className="relative w-full overflow-hidden py-1" aria-label="Plataformas suportadas pelo Allavsoft">
      ...
      <div className="allavsoft-marquee-track flex w-max gap-3 hover:[animation-play-state:paused] sm:gap-4">
        {loop.map((logo, index) => (
