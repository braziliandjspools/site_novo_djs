  ...
  return (
    <div className="relative mb-6 overflow-hidden rounded-2xl sm:mb-8">
      <Image
        ...
        aria-hidden
      />
      <div className="absolute inset-0 bg-gradient-to-r from-black/80 via-black/50 to-black/25" aria-hidden />
      <div className="absolute inset-0 bg-gradient-to-t from-[#1e1e1e] via-transparent to-black/15" aria-hidden />
