...
export const MUSICAS_FAQS: MusicasFaq[] = [
  ...
  },
  {
    ...
    a: "Sim. VIP baixa faixa a faixa no navegador ou envia para o BRS Downloader Windows (versão atual do site, ex.: 1.0.15_estable) com o mesmo login da conta.",
  },
  {
