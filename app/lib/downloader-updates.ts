 ...
 * - DOWNLOADER_LATEST_VERSION=1.0.3_public_beta
 * - DOWNLOADER_DOWNLOAD_URL=https://www.brazilianremixservice.com.br/downloads/BRS-Downloader_1.0.3_public_beta_x64-setup.exe
 */
...
const FALLBACK_VERSION = "1.0.3_public_beta";
const FALLBACK_DOWNLOAD_URL =
  "https://www.brazilianremixservice.com.br/downloads/BRS-Downloader_1.0.3_public_beta_x64-setup.exe";
const FALLBACK_NOTES =
  "BRS Downloader 1.0.3_public_beta: corrige o sininho de notificações aparecendo atrás da página.";
...
export function getDownloaderReleaseManifest(): DownloaderReleaseManifest | null {
  ...
  return {
    ...
    publishedAt: envPublishedAt ?? "2026-09-07T19:20:00.000Z",
    platform: "windows",
  };
}
