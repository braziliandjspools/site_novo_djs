 ...
 * - DOWNLOADER_LATEST_VERSION=1.0.15_estable
 * - DOWNLOADER_DOWNLOAD_URL=https://www.brazilianremixservice.com.br/downloads/BRS-Downloader_1.0.15_estable_x64-setup.exe
 */
...
const FALLBACK_VERSION = "1.0.15_estable";
const FALLBACK_DOWNLOAD_URL =
  "https://www.brazilianremixservice.com.br/downloads/BRS-Downloader_1.0.15_estable_x64-setup.exe";
const FALLBACK_NOTES =
  "BRS Downloader 1.0.15_estable: downloads simultâneos (1–10, padrão 3) e TXT de falhas na pasta de destino para enviar ao suporte.";
const FALLBACK_PUBLISHED_AT = "2026-09-20T21:00:00.000Z";
